...
const ss = (o) => document.querySelectorAll(o);
// const sf = (o) => s('iframe').contentWindow.document.querySelector(o);
// const sfs = (o) => s('iframe').contentWindow.document.querySelectorAll(o);
// const { log } = console;
